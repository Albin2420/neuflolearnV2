          ...
          children: [
            ...
            Obx(() {
              return Testhourcard(
                ...
                seconds: ctr.stdataPracticeTest["total_time_spent"],
              );
            }),
            SizedBox(
              height: 16,
            ...
            Obx(() {
              return ProgressGraphtile(
                weekdata: ctr.stdataPracticeTest['daily_average_time'],
              );
            }),
            SizedBox(
              height: 16,
            ...
            Obx(() {
              return TimeGrowthGraph(
                  seconds: ctr.stdataPracticeTest['average_time_per_question']);
            }),
            SizedBox(
              height: 40,
            ),
