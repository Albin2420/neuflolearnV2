        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() {
              return Testhourcard(
                testAttended:
                    '${ctrc.stdataMockTest["total_mock_tests_attended"]}',
                seconds: ctrc.stdataMockTest["total_time_spent"],
              );
            }),
            SizedBox(
              height: 16,
            ...
            Obx(() {
              return ProgressGraphtile(
                weekdata: ctrc.stdataMockTest['daily_average_time'],
              );
            }),
            SizedBox(
              height: 16,
                        ...
                        Row(
                          children: [
                            SizedBox(
                              ...
                              width: 18,
                              child:
                                  Image.asset("assets/icons/wrong_square.png"),
                            ),
                            SizedBox(
                              width: 4,
                            ),
            ...
            Obx(() {
              return Scoregrowthgraph(
                score: "${(ctrc.stdataMockTest['average_score'] ?? 0).toInt()}",
              );
            }),
            SizedBox(
              height: 16,
            ...
            Obx(() {
              return TimeGrowthGraph(
                  seconds: ctrc.stdataMockTest['average_time_per_question']);
            }),
            SizedBox(
              height: 40,
            ),
